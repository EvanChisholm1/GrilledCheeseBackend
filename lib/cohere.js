async function cohereApiCall(prompt, max_tokens = 500, temperature = 0) {
...
export async function analyzeFactualnessFromSource(url) {
    ...
    const prompt = `give me a decisive analysis of the how factually correct the information is on ${source}`;
